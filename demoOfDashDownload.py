...
df = px.data.iris()
# Here x is feature 1 and y is feature 2
# 1. We have to do classwise 
# 2. We have to do for all classes for which color option is provided
fig1 = px.line(df, x="sepal_width", y="petal_length")
fig1.update_traces(line=dict(color = 'rgba(50,50,50,0.2)'))

fig2 = px.scatter(df, x="sepal_width", y="petal_length",color="species")

fig3 = go.Figure(data=fig1.data + fig2.data)
#fig3.show()
plotly.offline.plot(fig3, filename= "demoOfPlotly1.html",auto_open=False)
# import dash
# import plotly.express as px
